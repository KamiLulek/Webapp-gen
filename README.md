...
- Ikona na pasku zadań grupuje się z głównym Chromium lub pojawia się jako osobne okno
- Launcher nie jest bezpośrednio powiązany z uruchomionym oknem - są to dwa oddzielne byty
```
EN:
```
